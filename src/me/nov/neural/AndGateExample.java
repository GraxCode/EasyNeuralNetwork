...
public class AndGateExample {
	public static void main(String[] args) {
		NeuralNetworkLinear nn = new NeuralNetworkLinear();
		...
		System.out.println("0 1 -> " + nn.compute(new double[] { 0, 1 }));
		System.out.println("1 1 -> " + nn.compute(new double[] { 1, 1 }));
		System.out.println(Arrays.toString(nn.weightsO) + " " + Arrays.deepToString(nn.weightsHL1) + " "
				+ Arrays.deepToString(nn.weightsHL2));
	}
}
